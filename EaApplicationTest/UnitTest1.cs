...
public class UnitTest1
{
    ...
    public async Task Test1()
    {
        ...
        await page.WaitForSelectorAsync("label[for='UserName']");
        ...
        //await page.GetByRole(AriaRole.Link, new PageGetByRoleOptions { Name = "Employee" }).ClickAsync();


        Console.WriteLine(await page.ContentAsync());
        await page.Locator("a:has-text('View Employees')").WaitForAsync(new LocatorWaitForOptions
        {
            State = WaitForSelectorState.Visible
        });
        await page.Locator("a:has-text('View Employees')").ClickAsync();
    }
